...
namespace WebApplicationEcoleWeb.Controllers
{
    public class StagiairesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,DateNaissance,DateInscription,AdressePostale,Statut,SessionSouhaite")] Stagiaire stagiaire)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,DateNaissance,DateInscription,AdressePostale,Statut,SessionSouhaite")] Stagiaire stagiaire)
        {
            if (ModelState.IsValid)
            {
